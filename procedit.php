...
$query="UPDATE activity SET Description='$desc', Name='$name', Pdate='$date' WHERE SN='$Id' ";
$result=mysqli_query($db, $query);
if($result){
echo "<script> alert('Procurement Details updated successfully!');</script>";
}
else{echo "<script> alert('Procurement Details update failed!');</script>";}
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li class="active"><a href="procurement.php"><svg class="glyph stroked dashboard-dial"><use xlink:href="#stroked-dashboard-dial"></use></svg> Procurement list</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Procurement Details</h1>
			</div>
    ...
    <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="myModalLabel">Edit procurements Details</h4>
                </div>
       ...
       <div  class="table-responsive col-lg-12" >
               ...
               <?php  
                 ...
                 while($row=mysqli_fetch_array($result)){
                  $q="SELECT SN from activity WHERE SN='".$row['SN']."'";
                  $r=mysqli_query($db, $q);
