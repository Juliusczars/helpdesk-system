...
$edit="UPDATE employee SET Address='$Address', Email='$email', Contact='$tel' where P_no='$n'";

if( is_numeric($tel) && strlen($tel)>8 && $tel>-1  ){
...
echo "<script> alert('Failed Enter an appropriate Contact number!');</script>";
