                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="ibox-title">
                            <h3 class="lic">Open support tickets Report from Date:<?php echo $_POST['start-date'];?> to Date:<?php echo $_POST['end-date'];?>  </h3>
                        </div>
                ...
                <div class="ibox-content">
                    <table id="trans_table"  class="table table-striped">
                       ...
                       $end=$_POST['end-date'];
                          ...
                          $query= "SELECT Ticket_no, employee.Fname, s_ticket.P_no, Ext_no, Cdate, Fault, s_ticket.Department, Location, Timecreated, Createdby from s_ticket, employee WHERE Cdate >='$start' and Cdate <='$end'  AND employee.P_no=s_ticket.P_no AND Status='open'";
