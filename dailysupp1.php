...
<title>Daily (tickets created) ticketing report</title>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="ibox-title">
                            <h3>Support Tickets created Report on Date:<?php echo $_POST['start-date'];?>   </h3>
                        </div>
                ...
                <div class="ibox-content">
                    <table id="trans_table"  class="table table-striped">
                       ...
                       $start=$_POST['start-date'];
                          ...
                          $query= "SELECT Ticket_no, employee.Fname, s_ticket.P_no, Ext_no, Cdate, Fault, s_ticket.Department, Location, Status, Timecreated, Createdby from s_ticket, employee WHERE employee.P_no=s_ticket.P_no AND Cdate ='$start'";
