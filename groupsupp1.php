...
<title>Summary (tickets created) report</title>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="ibox-title">
                            <h3>Created support tickets Summary Report  from Date:<?php echo $_POST['start-date'];?> to Date:<?php echo $_POST['end-date'];?>  </h3>
                        </div>
                ...
                <div class="ibox-content">
                    <table id="trans_table"  class="table table-striped">
                       ...
                       $end=$_POST['end-date'];
                          ...
                          $query= "SELECT Fault, count(Fault) AS tally FROM s_ticket WHERE Cdate >='$start' and Cdate <='$end' GROUP BY Fault";
