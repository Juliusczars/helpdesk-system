...
<title>Daily (Open tickets) ticketing report</title>
        ...
        <form method="post" action= "dailywshop.php" name="report">
                    <div class="row">
                        ...
                        <div class="form-group col-lg-2">
                          <a href="#" id="showyield"><input type="submit" class="btn btn-primary pull-right" value="Generate Report" id="btn" /></a>
                        </div>
                    </div>
...
<div id="Groupsupp" style="display:none;">
       <div class="panel-heading">
                    <h4>Configure on open tickets Report(Grouped)</h4>
                </div>
...
<div id="groupcreate" style="display:none;">
       <div class="panel-heading">
                    <h4>Configure range on tickets created Report(Grouped)</h4>
                </div>
...
<div id="groupun" style="display:none;">
       <div class="panel-heading">
        ...
        <form method="post" action= "groupwshop2.php.php" name="report">
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="form-group">
                                <label>Select a Date </label>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="ibox-title">
                            <h3>Closed workshop Tickets Report  on Date:<?php echo $_POST['start-date'];?>   </h3>
                        </div>
                ...
                <div class="ibox-content">
                    <table id="trans_table"  class="table table-striped">
                       ...
                       $start=$_POST['start-date'];
                          ...
                          $query= "SELECT Ticket_no, employee.Fname, w_ticket.P_no, Ext_no, Cdate, Device, Info, Fault, w_ticket.Department, Location, Time, Createdby from w_ticket, employee WHERE employee.P_no=w_ticket.P_no AND Cdate ='$start' AND Status='closed'";
