...
$w=mysqli_query($db, "SELECT SUM(Quantity) AS total from product");
                          $e=mysqli_fetch_object($w);
                          $d=$e->total;
                         // echo" <tr>
                         //     <th>Total</th>
                         //      <th></th>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="ibox-title">
                            <h3>Inventory Report : Total: <?php echo $d; ?>     </h3>
                        </div>
                ...
                <div class="ibox-content">
                    <table id="trans_table"  class="table table-striped">
                       ...
                       <?php 
                          ...
                          $query= "SELECT DISTINCT product.P_id, Name, product.Description, Orderlev, product.Quantity from product, activity WHERE product.P_id=activity.P_id GROUP BY product.P_id";
