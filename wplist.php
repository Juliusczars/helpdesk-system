    ...
    <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
               ...
               <form method="post" action="wpedit.php">
                <div class="modal-body">
                    <div class="row">
                     ...
                     <div class="row">
                        ...
                        <div class="form-group col-xs-8">
                            <label >Device and it's Info</label>
                            <select type="text" name="dev" id="dev" class="form-control" required>  
                ...
                <option>UPS</option>
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-xs-8">
                            <label >Info</label>
                            <input type="text" name="info" id="info" class="form-control" placeholder="Device info" required>  
                       </div>
                    </div> 
                ...
                <div class="ibox-content">
                  ...
                  <thead><th>Ticket#</th>
                       ...
                       <?php 
                          ...
                          $query= "SELECT Ticket_no, employee.Fname, w_ticket.P_no, Ext_no, Cdate, Device, Info, Fault, w_ticket.Department, Location, Status, Time, Createdby from w_ticket, employee WHERE employee.P_no=w_ticket.P_no ";
                        ...
                        while($row=mysqli_fetch_array($result)){
                           $q="SELECT Ticket_no from w_ticket WHERE Ticket_no='".$row['Ticket_no']."'";
                            ...
                            echo "<tr>
                                ...
                                <td class='dev'>".$row['Device']."</td>
                                <td class='inf'>".$row['Info']."</td>
          ...
          $('.btn-default').click(function(){
            var $row=$(this).closest('tr');
               var ext=$row.find('.ext').text();
                var dev=$row.find('.dev').text();
                var info=$row.find('.inf').text();
