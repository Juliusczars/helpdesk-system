...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
       ...
       <div class="panel-heading">
                    <h4>Configure the range on user helpdesk activity</h4>
                </div>
        <form method="post" action= "repopar1.php" name="report">
                    <div class="row">
                        <div class="col-lg-5">
      ...
      <div class="row" style="height:;" id="table">
            ...
            <div  class="table-responsive col-lg-12" >
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="ibox-title">
                            <h3>Helpdesk user activity Report  From Date:<?php echo $_POST['start-date'];?>  To Date: <?php echo $_POST['end-date'];?>  </h3>
                        </div>
               ...
               $start=$_POST['start-date'];
                $end=$_POST['end-date'];
                  $query="SELECT users.P_no, employee.Fname, employee.Lname, users.username, count(s_task.Solution) AS tally from users, employee, s_task WHERE s_task.Cdate>='$start' and s_task.Cdate<='$end' AND users.P_no=employee.P_no AND users.username=s_task.officer AND Solution!='pending' GROUP BY users.P_no ";
