...
<title>Ranged (open tickets) ticketing report</title>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4>Configure workshop ticketing Report</h4>
                </div>
                <div class="panel-body">
                  <!--  <form method="post" action= "report1.php" name="report"> -->
                   <div style="float:left;padding:0 50px;"><input type="submit" class="btn btn-primary pull-right" value="Created Tickets"  onclick="show1()"/></div>
                    ...
                    <div style="float:left;padding:0 50px;"><input type="submit" class="btn btn-primary pull-right" value="closed Tickets" onclick="show2()" /></div><br>
...
<div id="Dailysupp" style="display:none;">
       <div class="panel-heading">
        ...
        <form method="post" action= "dailywshop.php" name="report">
                    <div class="row">
                        <div class="col-lg-5">
...
<div id="Rangesupp" style="display:none;">
       <div class="panel-heading">
                    <h4>Configure the range on opened tickets Report</h4>
                </div>
        <form method="post" action= "rangewshop.php" name="report">
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="form-group">
                                <label>Select a Date </label>
...
<div id="Groupsupp" style="display:none;">
       <div class="panel-heading">
        ...
        <form method="post" action= "groupwshop.php" name="report">
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="form-group">
                                <label>Select a Date </label>
       ...
       <div class="panel-heading">
        ...
        <form method="post" action= "dailywshop1.php" name="report">
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="form-group">
                                <label>Select a Date </label>
...
<div id="Rangecreate" style="display:none;">
       <div class="panel-heading">
        ...
        <form method="post" action= "rangewshop1.php" name="report">
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="form-group">
                                <label>Select a Date </label>
...
<div id="groupcreate" style="display:none;">
       <div class="panel-heading">
        ...
        <form method="post" action= "groupwshop1.php" name="report">
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="form-group">
                                <label>Select a Date </label>
       ...
       <div class="panel-heading">
        ...
        <form method="post" action= "dailywshop2.php" name="report">
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="form-group">
                                <label>Select a Date </label>
...
<div id="Rangeun" style="display:block;">
       <div class="panel-heading">
        ...
        <form method="post" action= "rangewshop2.php" name="report">
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="form-group">
                                <label>Select a Date </label>
...
<div id="groupun" style="display:none;">
       <div class="panel-heading">
        ...
        <form method="post" action= "groupwshop2.php" name="report">
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="form-group">
                                <label>Select a Date </label>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="ibox-title">
                            <h3>Closed workshop tickets Report from Date:<?php echo $_POST['start-date'];?> to Date:<?php echo $_POST['end-date'];?>  </h3>
                        </div>
                ...
                <div class="ibox-content">
                    <table id="trans_table"  class="table table-striped">
                       ...
                       $end=$_POST['end-date'];
                          ...
                          $query= "SELECT Ticket_no, employee.Fname, w_ticket.P_no, Ext_no, Cdate, Device, Info, Fault, w_ticket.Department, Location, Time, Createdby from w_ticket, employee WHERE Cdate >='$start' and Cdate <='$end'  AND employee.P_no=w_ticket.P_no AND Status='closed'";
