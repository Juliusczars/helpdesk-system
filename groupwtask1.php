...
<div id="groupcreate" style="display:block;">
       <div class="panel-heading">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="ibox-title">
                            <h3>Complete workshop tasks summary Report  on Date:<?php echo $_POST['start-date'];?>   </h3>
                        </div>
                ...
                <div class="ibox-content">
                    ...
                    $start=$_POST['start-date'];
                      $end=$_POST['end-date'];
                          ...
                          $query= "SELECT Device, Fault, count(Fault) AS tally FROM w_ticket, w_task WHERE w_ticket.Cdate >='$start' and w_ticket.Cdate <='$end'  AND w_task.Ticket_no=w_ticket.Ticket_no GROUP BY Device";
