...
<title>Daily Support(Inc) Tasking report</title>
...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
       ...
       <div id="assigned" style="display:block; padding:50px 0;">
        <h5>Choose an option incomplete support tasks report</h5>
       ...
       <div id="create" style="display:none;padding:50px 0;">
         <h5>Choose an option on complete support tasks report</h5>
      ...
      <div id="groupie" style="display:none;padding:50px 0;">
         <h5>Choose an option on created support tasks report</h5>
...
<div id="Dailysupp" style="display:block;">
       <div class="panel-heading">
                    <h4>Configure incomplete support tasks Report(per day)</h4>
                </div>
...
<div id="Rangesupp" style="display:none;">
       <div class="panel-heading">
                    <h4>Configure the range on incomplete support tasks Report</h4>
                </div>
...
<div id="Groupsupp" style="display:none;">
       <div class="panel-heading">
                    <h4>Configure range on Incomplete support tasks Report(summary)</h4>
                </div>
       ...
       <div class="panel-heading">
                   <h4>Configure on complete support tasks Report(per day)</h4>
                </div>
...
<div id="Rangecreate" style="display:none;">
       <div class="panel-heading">
                    <h4>Configure the range on complete support tasks Report</h4>
                </div>
...
<div id="groupcreate" style="display:none;">
       <div class="panel-heading">
                    <h4>Configure range on complete support tasks Report(Summary)</h4>
                </div>
       ...
       <div class="panel-heading">
                    <h4>Configure on support tasks created Report(per day)</h4>
                </div>
...
<div id="Rangeun" style="display:none;">
       <div class="panel-heading">
                    <h4>Configure the range on support tasks created Report</h4>
                </div>
...
<div id="groupun" style="display:none;">
       <div class="panel-heading">
                    <h4>Configure on support tasks created Report(summary)</h4>
                </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="ibox-title">
                            <h3>Incomplete Support tasks Report  on Date:<?php echo $_POST['start-date'];?>   </h3>
                        </div>
                ...
                <div class="ibox-content">
                    <table id="trans_table"  class="table table-striped">
                       ...
                       $start=$_POST['start-date'];
                          ...
                          $query= "SELECT s_task.Ticket_no, s_task.Officer, s_task.Cdate, s_ticket.Fault, s_ticket.Department, s_ticket.Location, s_task.Createdby from s_ticket, s_task WHERE s_task.Cdate >='$start'  AND s_task.Ticket_no=s_ticket.Ticket_no AND s_task.Solution='pending'";
