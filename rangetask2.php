...
<title>Ranged Support(cre.) Tasking report</title>
...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
      ...
      <div id="groupie" style="display:block;padding:50px 0;">
...
<div id="Rangeun" style="display:block;">
       <div class="panel-heading">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="ibox-title">
                            <h3>Created support tasks  Report  from Date:<?php echo $_POST['start-date'];?>  to Date:<?php echo $_POST['end-date'];?>    </h3>
                        </div>
                ...
                <div class="ibox-content">
                    <table id="trans_table"  class="table table-striped">
                       ...
                       $start=$_POST['start-date'];
                         $end=$_POST['end-date'];
                          $query= "SELECT s_task.Ticket_no, s_task.Officer, s_task.Cdate, s_task.Timeclosed, s_ticket.Fault, s_task.Solution, s_ticket.Department, s_ticket.Location, s_task.Createdby from s_ticket, s_task WHERE s_task.Cdate >='$start' and s_task.Cdate<='$end'  AND s_task.Ticket_no=s_ticket.Ticket_no ";
