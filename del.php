...
$que="DELETE FROM users WHERE P_no='$btn'";
$res=mysqli_query($db, $que);
if($res){
 echo "<script> alert('User details deleted successfully!');</script>";

}
else{ echo "<script> alert('User details delete failed!');</script>";}
    ...
    <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        ...
        <div  class="table-responsive col-lg-12" >
                ...
                <div class="ibox-content">
                    ...
                    <tbody>
               <?php  
                  $query="SELECT users.P_no, Fname, Lname, username, employee.Email, password from users, employee WHERE users.P_no=employee.P_no ";
