...
$query="UPDATE w_ticket SET Ext_no='$ext', Fault='$fault', Device='$device', Info='$info', Department='$dept', Cdate='$date', Location='$loc' WHERE Ticket_no='$Id' ";
$result=mysqli_query($db, $query) or die(mysqli_error($db));
if($result){
echo "<script> alert('Workshop ticket Details updated successfully!');</script>";
}
else{echo "<script> alert('Workshop ticket update failed!');</script>";}
