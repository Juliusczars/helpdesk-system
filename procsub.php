...
$Id=$_POST['id'];
$pid=$_POST['desc'];
$query="UPDATE activity SET Quantity=Quantity-'$quo' WHERE SN='$Id'";
$query1="UPDATE product SET Quantity=Quantity-'$quo' WHERE P_id='$pid'";
if(is_numeric($quo)&& $quo>0){
$result=mysqli_query($db, $query);
if($result){
    mysqli_query($db, $query1);
    echo "<script> alert('Product quantity Subtracted successfully!');</script>";
}
else{echo "<script> alert('Operation failed!');</script>";}
}
else{echo "<script> alert('Operation failed enter a numeric entry greater than 0 !');</script>";}
...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">           
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Procurements</h1>
            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <form method="post" action="procsub.php"> 
    ...
    <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
               ...
               <form method="post" action="procadd.php">
                <div class="modal-body">
