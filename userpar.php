    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">           
        ...
        <div  class="table-responsive col-lg-12" >
                ...
                <br>
                    ...
                    <tbody>
               <?php  
                  $query="SELECT users.P_no, employee.Fname, employee.Lname, users.username, count(s_task.Solution) AS tally from users, employee, s_task WHERE users.P_no=employee.P_no AND users.username=s_task.officer AND Solution!='pending' GROUP BY users.P_no ";
            ...
            <a href="repopar.php">Generate a report</a>
        </div>
        </div>
