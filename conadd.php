...
$query="INSERT into users values('$pno', '$user', '$email', '$pass')";
...
else{ echo "<script> alert('User creation  failed!confirm details');</script>";
}
...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
        ...
        <div class="panel-body">
            <form method="post" Action="conadd.php">
            <div class="row">
