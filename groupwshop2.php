...
<title>Summary (open tickets)report</title>
...
<div id="Rangesupp" style="display:none;">
       <div class="panel-heading">
                    <h4>Configure the range on on open tickets Report</h4>
                </div>
...
<div id="Groupsupp" style="display:none;">
       ...
       <div class="panel-heading">
                   <h4>Configure daily tickets created Report</h4>
                </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="ibox-title">
                            <h3>Closed workshop tickets Summary Report  from Date:<?php echo $_POST['start-date'];?> to Date:<?php echo $_POST['end-date'];?>  </h3>
                        </div>
                ...
                <div class="ibox-content">
                    <table id="trans_table"  class="table table-striped">
                       ...
                       $end=$_POST['end-date'];
                          ...
                          $query= "SELECT Device, Fault, count(Fault) AS tally FROM w_ticket WHERE Cdate >='$start' and Cdate <='$end' AND Status='closed' GROUP BY Device";
