...
<title>Summary Support(comp) Tasking report</title>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="ibox-title">
                            <h3>Completed support tasks Summary Report  from Date:<?php echo $_POST['start-date'];?>  to Date:<?php echo $_POST['end-date'];?>    </h3>
                        </div>
                ...
                <div class="ibox-content">
                    <table id="trans_table"  class="table table-striped">
                       ...
                       $end=$_POST['end-date'];
                          ...
                          $query= "SELECT s_ticket.Fault, count(s_ticket.Fault) AS tally FROM s_ticket, s_task WHERE s_task.Cdate >='$start' and s_task.Cdate <='$end' AND s_task.Solution!='pending' GROUP BY s_ticket.Fault";
