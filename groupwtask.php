...
<title>Workshop (inc. )Tasking report</title>
...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
       ...
       <div id="assigned" style="display:block; padding:50px 0;">
...
<div id="Groupsupp" style="display:block;">
       <div class="panel-heading">
...
<div id="groupun" style="display:none;">
      ...
      <div class="row" style="height:;" id="table">
            ...
            <div id="yield2" style="display:block;">
            <div  class="table-responsive col-lg-12" >
                <div class="panel panel-default">

                    <div class="panel-body">
                        <div class="ibox-title">
                            <h3>Incomplete Workshop tasks Report  from Date:<?php echo $_POST['start-date'];?> to Date:<?php echo $_POST['end-date'];?>  </h3>
                        </div>
                ...
                <div class="ibox-content">
                    <table id="trans_table"  class="table table-striped">
                       ...
                       $end=$_POST['end-date'];
                          ...
                          $query= "SELECT Device, Fault, count(Fault) AS tally FROM w_ticket LEFT JOIN w_task ON w_task.Ticket_no=w_ticket.Ticket_no WHERE w_ticket.Cdate >='$start' and w_ticket.Cdate <='$end'  AND w_task.Ticket_no IS NULL GROUP BY Device";
	...
	<script>
       ...
       function cshow() { 
        ...
        if(document.getElementById('Dailysupp').style.display=='none') { 
            ...
            document.getElementById('yield2').style.display='none';
        } 
