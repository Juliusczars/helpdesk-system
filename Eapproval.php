...
$btn=$_POST['user_id'];
$quo=$_POST['quantity'];
$que="UPDATE ordering SET Status='$approv', Quantity='$quo' WHERE Order_Id='$btn'";

if(is_numeric($quo) and $quo>0){
    $res=mysqli_query($db, $que) or die(mysqli_error($db));
if($res){
 echo "<script> alert('Approvals updated successfully!');</script>";
 
}
else{ echo "<script> alert('Approvals update failed!');</script>";}
}
else{echo "<script> alert('Approvals update failed! Value entered for quantity is not numeric');</script>";}
?>
<!DOCTYPE html>
<html>
...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Order approvals</h1>
			</div>
    ...
    <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="myModalLabel">Approval Status</h4>
                </div>
               <form method="post" action="Eapproval.php">
                <div class="modal-body">
                    <div class="row">
