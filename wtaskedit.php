...
$query="UPDATE w_task SET Repairer='$officer',Cdate='$date', Solution='$sol' WHERE Ticket_no='$Id' ";
$result=mysqli_query($db, $query);
if($result){
echo "<script> alert('Workshop task Details updated successfully!');</script>";
}
else{echo "<script> alert('Workshop task Details update failed!');</script>";}
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
      ...
      <li class="parent"> <a href="#"><span data-toggle="collapse" href="#sub-item-2"><svg class="glyph stroked checkmark"><use xlink:href="#stroked-checkmark"/></use></svg></span>Workshop</a>
		...
		<li><a href="workshop.php">  Back</a></li>
		</ul>
    ...
    <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
               ...
               <form method="post" action="wtaskedit.php">
                <div class="modal-body">
                    <div class="row">
                         <input hidden id="user_id" name="user_id">
                        <div class="form-group col-xs-8">
                        	<label >Repairing Officer</label>
                    ...
                    <div class="row">
                     ...
                     <div class="row">
                        ...
                        <div class="form-group col-xs-8">
                          ...
                          <input type="text" name="sol" id="sol" class="form-control" required>  
                       </div>
                    </div> 
                ...
                <div class="ibox-content">
                 ...
                 <thead>
                      ...
                      // $end=$_POST['end-date'];
                           ...
                           $query= "SELECT w_task.Ticket_no, Repairer, w_ticket.Cdate AS wdate, w_task.Cdate, Device, Info, Fault, Solution, w_task.Createdby from w_ticket, w_task WHERE w_task.Ticket_no=w_ticket.Ticket_no";
                          $result=mysqli_query($db,$query);
                     //   if(empty($start)||empty($end)){ $start="N/A"; $end="N/A";echo "<script type='text/javascript'> alert('Both dates are required.Please fill in both dates');</script>";}
                       ...
                       //  }
                        ...
                        while($row=mysqli_fetch_array($result)){
                           $q="SELECT Ticket_no from w_task WHERE Ticket_no='".$row['Ticket_no']."'";
                            $r=mysqli_query($db, $q);
                            $t=mysqli_fetch_object($r);
                            echo "<tr>
                                <td>".$row['Ticket_no']."</td>
                                <td class='of'>".$row['Repairer']."</td>
                                <td>".$row['wdate']."</td>
		...
		$(window).on('resize', function () {
          ...
          $('.btn-default').click(function(){
            var $row=$(this).closest('tr');
               var of=$row.find('.of').text();
                var sol=$row.find('.sol').text();
