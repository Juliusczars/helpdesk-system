...
<title>daily Workshop(Inc.) Tasking report</title>
...
<div id="Dailysupp" style="display:block;">
       <div class="panel-heading">
...
<div id="groupun" style="display:none;">
      ...
      <div class="row" style="height:;" id="table">
            ...
            <div id="yield" style="display:block;">
            <div  class="table-responsive col-lg-12" >
                <div class="panel panel-default">

                    <div class="panel-body">
                        <div class="ibox-title">
                            <h3>Incomplete Workshop tasks Report  on Date:<?php echo $_POST['start-date'];?>   </h3>
                        </div>
                ...
                <div class="ibox-content">
                    <table id="trans_table"  class="table table-striped">
                       ...
                       $start=$_POST['start-date'];
                          ...
                          $query= "SELECT w_ticket.Ticket_no, Device, Info, w_ticket.Cdate, Fault, w_ticket.Createdby from w_ticket LEFT JOIN w_task ON w_task.Ticket_no=w_ticket.Ticket_no WHERE w_ticket.Cdate ='$start' AND w_task.Ticket_no IS NULL  ";
    ...
    function Rshow() { 
        ...
        if(document.getElementById('Rangesupp').style.display=='none') { 
            ...
            document.getElementById('Groupsupp').style.display='none';
            document.getElementById('yield').style.display='none';
        } 
