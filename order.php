...
$sql="INSERT into Ordering  values(NULL, '$desc', '$quo', '$date', '$R', 'pending', 'pending', NULL, '$login_session')";

if(empty($date)){$message="Failed.Please select a date!!";}
elseif(is_numeric($quo) && $quo>0){
...
if($result){
 ...
 $message="Order placement failed!!";
	...
	$message="Quantity value entered is not numeric";
}
?>
...
<body>
	...
	<div id="body">
		...
		<form method="post" action="#">
			<h3>Ordering details</h3><p style="color:red;"><?php echo $message;?></p>
			<label for="name">
