...
<title>daily Support(comp) Tasking report</title>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="ibox-title">
                            <h3>Completed Support tasks Report  on Date:<?php echo $_POST['start-date'];?>   </h3>
                        </div>
                ...
                <div class="ibox-content">
                    <table id="trans_table"  class="table table-striped">
                       ...
                       $start=$_POST['start-date'];
                          ...
                          $query= "SELECT s_task.Ticket_no, s_task.Officer, s_task.Cdate, Timeclosed, s_ticket.Fault, Solution, s_ticket.Department, s_ticket.Location, s_task.Createdby from s_ticket, s_task WHERE s_task.Cdate >='$start'  AND s_task.Ticket_no=s_ticket.Ticket_no AND s_task.Solution!='pending'";
