                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="ibox-title">
                            <h3>Created workshop Tickets Report  on Date:<?php echo $_POST['start-date'];?>   </h3>
                        </div>
                ...
                <div class="ibox-content">
                    <table id="trans_table"  class="table table-striped">
                       ...
                       $start=$_POST['start-date'];
                          ...
                          $query= "SELECT Ticket_no, employee.Fname, w_ticket.P_no, Ext_no, Cdate, Device, Info, Fault, w_ticket.Department, Location, Status, Time, Createdby from w_ticket, employee WHERE employee.P_no=w_ticket.P_no AND Cdate ='$start'";
