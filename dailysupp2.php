...
<title>Daily (closed) ticketing report</title>
...
<div id="groupcreate" style="display:none;">
       <div class="panel-heading">
        ...
        <form method="post" action= "" name="report">
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="form-group">
                                <label>Select a Date </label>
           ...
           <!-- Unassigned -->
                ...
                <div id="Dailyun" style="display:blocks;">
       <div class="panel-heading">
...
<div id="groupun" style="display:none;">
       <div class="panel-heading">
        ...
        <form method="post" action= "groupsup.php" name="report">
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="form-group">
                                <label>Select a Date </label>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="ibox-title">
                            <h3>Closed support tickets Report  on Date:<?php echo $_POST['start-date'];?>   </h3>
                        </div>
                ...
                <div class="ibox-content">
                    <table id="trans_table"  class="table table-striped">
                       ...
                       $start=$_POST['start-date'];
                          ...
                          $query= "SELECT Ticket_no, employee.Fname, s_ticket.P_no, Ext_no, Cdate, Fault, s_ticket.Department, Location, Timecreated, Createdby from s_ticket, employee WHERE employee.P_no=s_ticket.P_no AND Cdate ='$start' AND Status='closed'";
