...
$sql="INSERT into s_ticket values(NUll, '$pno', '$Ext', '$date', '$fault', '$dept', '$loc', 'open', NUll, '$login_session')";
      ...
      <P style="color:red"><?php echo $message?></P>
		...
		<td><label for="PNO">
			...
			<tr><td><label for="date">
				<span>Date</span>
				<input type="text" id="date" name="date" style="margin:15px 0 15px 47px;" required>
			</label></td><td>
			<label for="fault">
				<span>Fault</span>
...
<div id="Proc-right" >
      ...
      <label for="date">
        ...
        <input type="text" name="datet" readonly="true" required>
      </label>
