...
$sql="INSERT into w_ticket values(NULL, '$pno', '$Ext', '$date', '$fault', '$dept', '$dev', '$inf', '$loc', 'open', NULL, '$login_session')";
...
<div id="Proc-right" >
        ...
        <label for="sol" style="padding-top:60px;margin-top:60px;">
				...
				<textarea name="sol" id="mess" name="mess" cols="30" rows="10" required></textarea>
			</label>
