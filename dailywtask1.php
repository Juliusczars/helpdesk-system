...
<title>Workshop(comp.) Tasking report</title>
...
<div id="Groupsupp" style="display:none;">
       <div class="panel-heading">
        ...
        <form method="post" action= "groupwtask.php" name="report">
               ...
               <div id="createsupp" style="display:block;">
       <div class="panel-heading">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="ibox-title">
                            <h3>Complete workshop tasks Report  on Date:<?php echo $_POST['start-date'];?>   </h3>
                        </div>
                ...
                <div class="ibox-content">
                    <table id="trans_table"  class="table table-striped">
                      ...
                      // $end=$_POST['end-date'];
                           ...
                           $query= "SELECT w_task.Ticket_no, Repairer, w_ticket.Cdate, w_task.Cdate, Device, Info, Fault, Solution, w_task.Createdby from w_ticket, w_task WHERE w_task.Cdate ='$start' AND w_task.Ticket_no=w_ticket.Ticket_no";
