...
<title>Workshop(comp.ss) Tasking report</title>
...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h2 class="page-header">KNH ICT WORKSHOP REPORTS</h2>
			</div>
		</div><!--/.row-->
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4>Configure workshop tasking Report</h4>
                </div>
                <div class="panel-body">
                  <!--  <form method="post" action= "report1.php" name="report"> -->
                    <!--       <div style="float:left;padding:0 50px;"><input type="submit" class="btn btn-primary pull-right" value="Tasks Created" onclick="show2()"/></div> -->
                    <div style="float:left;padding:0 50px;"><input type="submit" class="btn btn-primary pull-right" value="Complete Tasks"  onclick="show1()"/></div>
                    <div style="float:left;padding:0 50px;"><input type="submit" class="btn btn-primary pull-right" value="Incomplete Tasks" onclick="show()"/></div>
       ...
       <div id="assigned" style="display:none; padding:50px 0;">
        <h5>Choose an option on incomplete workshop tasks report</h5>
       ...
       <div id="create" style="display:block;padding:50px 0;">
         <h5>Choose an option on complete workshop tasks report</h5>
      ...
      <div id="groupie" style="display:none;padding:50px 0;">
         <h5>Choose an option on created workshop tasks report</h5>
...
<div id="Dailysupp" style="display:none;">
       <div class="panel-heading">
                    <h4>Configure incomplete workshop tasks Report(per day)</h4>
                </div>
        <form method="post" action= "dailywtask.php" name="report">
                    <div class="row">
                        <div class="col-lg-5">
...
<div id="Rangesupp" style="display:none;">
       <div class="panel-heading">
                    <h4>Configure the range on incomplete workshop tasks Report</h4>
                </div>
        <form method="post" action= "rangewtask.php" name="report">
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="form-group">
                                <label>Select a Date </label>
...
<div id="Groupsupp" style="display:none;">
       <div class="panel-heading">
                    <h4>Configure range on Incomplete workshop tasks Report(summary)</h4>
                </div>
        <form method="post" action= "groupwtask.php" name="report">
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="form-group">
                                <label>Select a Date </label>
       ...
       <div class="panel-heading">
                   <h4>Configure on complete workshop tasks Report(per day)</h4>
                </div>
        <form method="post" action= "dailywtask1.php" name="report">
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="form-group">
                                <label>Select a Date </label>
...
<div id="Rangecreate" style="display:block;">
       <div class="panel-heading">
                    <h4>Configure the range on complete workshop tasks Report</h4>
                </div>
        <form method="post" action= "rangewtask1.php" name="report">
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="form-group">
                                <label>Select a Date </label>
...
<div id="groupcreate" style="display:none;">
       <div class="panel-heading">
                    <h4>Configure range on complete workshop tasks Report(Summary)</h4>
                </div>
        <form method="post" action= "groupwtask1.php" name="report">
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="form-group">
                                <label>Select a Date </label>
       ...
       <div class="panel-heading">
                    <h4>Configure workshop tasks created Report(per day)</h4>
                </div>
        <form method="post" action= "dailywtask2.php" name="report">
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="form-group">
                                <label>Select a Date </label>
...
<div id="Rangeun" style="display:none;">
       <div class="panel-heading">
                    <h4>Configure the range on workshop tasks created Report</h4>
                </div>
        <form method="post" action= "rangewtask2.php" name="report">
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="form-group">
                                <label>Select a Date </label>
...
<div id="groupun" style="display:none;">
       <div class="panel-heading">
                    <h4>Configure on workshop  tasks created Report(summary)</h4>
                </div>
        <form method="post" action= "groupwtask2.php" name="report">
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="form-group">
                                <label>Select a Date </label>
      ...
      <div class="row" style="height:;" id="table">
            ...
            <div id="yield1" style="display:block;">
            <div  class="table-responsive col-lg-12" >
                <div class="panel panel-default">

                    <div class="panel-body">
                        <div class="ibox-title">
                            <h3>Complete workshop tasks Report   from Date:<?php echo $_POST['start-date'];?> to Date:<?php echo $_POST['end-date'];?> </h3>
                        </div>
                ...
                <div class="ibox-content">
                    <table id="trans_table"  class="table table-striped">
                      ...
                      $end=$_POST['end-date'];
                           $query= "SELECT w_task.Ticket_no, Repairer, w_ticket.Cdate, w_task.Cdate, Device, Info, Fault, Solution, w_task.Createdby from w_ticket, w_task WHERE w_task.Cdate >='$start' and w_task.Cdate<='$end' AND w_task.Ticket_no=w_ticket.Ticket_no";
                         ...
                         elseif(strtotime($start)> strtotime($end)) {
                            echo "<script type='text/javascript'> alert('Inappropriate date range  select an appropriate range. ');
                            </script>";
                         }
	...
	<script>
        ...
        if(document.getElementById('assigned').style.display=='none') { 
            ...
            document.getElementById('yield1').style.display='none';
        } 
