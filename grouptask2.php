...
<title>Support Tasking report</title>
...
<div id="groupun" style="display:block;">
       <div class="panel-heading">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="ibox-title">
                            <h3>Created support tasks Summary Report  from Date:<?php echo $_POST['start-date'];?>  to Date:<?php echo $_POST['end-date'];?>    </h3>   </h3>
                        </div>
                    ...
                    <table id="trans_table"  class="table table-striped">
                       ...
                       $start=$_POST['start-date'];
                        $end=$_POST['end-date'];
                          ...
                          $query= "SELECT s_ticket.Fault, count(s_ticket.Fault) AS tally FROM s_ticket, s_task WHERE s_task.Cdate >='$start' and s_task.Cdate <='$end'  GROUP BY s_ticket.Fault";
