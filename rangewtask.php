...
<title>Workshop Tasking report</title>
                ...
                <div class="ibox-content">
                    <table id="trans_table"  class="table table-striped">
                       ...
                       $end=$_POST['end-date'];
                          ...
                          $query= "SELECT w_ticket.Ticket_no, Device, Info, w_ticket.Cdate, Fault, w_ticket.Createdby from w_ticket LEFT JOIN w_task ON w_task.Ticket_no=w_ticket.Ticket_no WHERE w_ticket.Cdate >='$start' and w_ticket.Cdate<='$end' AND w_task.Ticket_no IS NULL  ";
